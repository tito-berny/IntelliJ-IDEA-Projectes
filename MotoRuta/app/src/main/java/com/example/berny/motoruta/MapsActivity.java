...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /*MIRA SI ESTA EL GPS ENCENDIDO
        if (!myTracksLocationManager.isGpsProviderEnabled()) {
            String message = GoogleLocationUtils.getGpsDisabledMyLocationMessage(this);
    ...
    /**
     * Mira el estado del loalizador
     * Si es false lanza una alerta
